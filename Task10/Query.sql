...
/*
		Может я что-то не понял, но у меня у Fuller-a поле ReportsTo = null, запрос
	SELECT FirstName,LastName,EmployeeID FROM Employees WHERE ReportsTo IS NULL
	возвращает одну запись : Andrew Fuller 2
