...
namespace Task03
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            try
            {
                var arrayF = MyArray<int>.MyArray_with_random_int_values(29);
                ...
                var arrayS = MyArray<string>.MyArray_with_random_string_values(15);
                ...
                var arrayT = MyArray<char>.MyArray_with_random_char_values(26);
